...
var ASM_CONSTS = [function($0, $1) { return $( document.elementFromPoint( $0, $1 ) ).data( 'h' ); },
 function($0, $1) { return $( document.elementFromPoint( $0, $1 ) ).data( 'j' ); },
 function() { $( '#options' ).hide(); },
 function() { console.log( "show options" ); $( '#options' ).show(); },
 function($0) { return $( '[name=radius]' ).val(); },
 function($0) { return $( '[name="radius"]' ).val( $0 ); },
 function($0) { return $( '[name="mine_ratio"]' ).val( $0 ); }];
...
function _add_id_class(id,class_name){ $( "#" + UTF8ToString( id ) ).addClass( UTF8ToString( class_name ) ); }
function _create_cell(h,j,radius){ var points = UTF8ToString( points ); var polygon = document.createElementNS( "http://www.w3.org/2000/svg", "polygon" ); var cell_radius = 57.1593533487 / ( 2.0 * radius + 1.0 ); var x = h * 1.7320 * cell_radius + j * 0.8660 * cell_radius; var y = j * 1.5 * cell_radius; var points = [ 0.0, cell_radius, 0.866 * cell_radius, 0.5 * cell_radius, 0.866 * cell_radius, -0.5 * cell_radius, 0 * cell_radius, -cell_radius, -0.866 * cell_radius, -0.5 * cell_radius, -0.866 * cell_radius, 0.5 * cell_radius, 0.0, cell_radius ].join( "," ); $( polygon ) .appendTo( "#game" ) .attr({ "id": `cell_${h}_${j}`, "data-h": h, "data-j": j, "transform": `matrix(1,0,0,1,${x},${y})`, "points": points }); }
function _remove_id_class(id,class_name){ $( "#" + UTF8ToString( id ) ).removeClass( UTF8ToString( class_name ) ); }
function _remove_polygons(){ $( '#game > polygon' ).remove(); }
function _toggle_cell_class(h,j,class_name){ $( `#cell_${h}_${j}` ).toggleClass( UTF8ToString( class_name ) ); }
function _toggle_id_class(id,class_name){ $( "#" + UTF8ToString( id ) ).toggleClass( UTF8ToString( class_name ) ); }
...
/* global initializers */  __ATINIT__.push({ func: function() { __GLOBAL__I_000101() } }, { func: function() { __GLOBAL__sub_I_html_cpp() } }, { func: function() { __GLOBAL__sub_I_game_cpp() } }, { func: function() { __GLOBAL__sub_I_iostream_cpp() } });
...
Module['wasmTableSize'] = 6978;

Module['wasmMaxTableSize'] = 6978;

Module.asmGlobalArg = {};

Module.asmLibraryArg = { "abort": abort, "assert": assert, "enlargeMemory": enlargeMemory, "getTotalMemory": getTotalMemory, "setTempRet0": setTempRet0, "getTempRet0": getTempRet0, "abortOnCannotGrowMemory": abortOnCannotGrowMemory, "abortStackOverflow": abortStackOverflow, "nullFunc_ii": nullFunc_ii, "nullFunc_iii": nullFunc_iii, "nullFunc_iiii": nullFunc_iiii, "nullFunc_iiiii": nullFunc_iiiii, "nullFunc_iiiiid": nullFunc_iiiiid, "nullFunc_iiiiii": nullFunc_iiiiii, "nullFunc_iiiiiid": nullFunc_iiiiiid, "nullFunc_iiiiiii": nullFunc_iiiiiii, "nullFunc_iiiiiiii": nullFunc_iiiiiiii, "nullFunc_iiiiiiiii": nullFunc_iiiiiiiii, "nullFunc_iiiiij": nullFunc_iiiiij, "nullFunc_v": nullFunc_v, "nullFunc_vi": nullFunc_vi, "nullFunc_vii": nullFunc_vii, "nullFunc_viii": nullFunc_viii, "nullFunc_viiii": nullFunc_viiii, "nullFunc_viiiii": nullFunc_viiiii, "nullFunc_viiiiii": nullFunc_viiiiii, "nullFunc_viijii": nullFunc_viijii, "___cxa_allocate_exception": ___cxa_allocate_exception, "___cxa_find_matching_catch": ___cxa_find_matching_catch, "___cxa_throw": ___cxa_throw, "___cxa_uncaught_exception": ___cxa_uncaught_exception, "___gxx_personality_v0": ___gxx_personality_v0, "___lock": ___lock, "___map_file": ___map_file, "___resumeException": ___resumeException, "___setErrNo": ___setErrNo, "___syscall140": ___syscall140, "___syscall145": ___syscall145, "___syscall146": ___syscall146, "___syscall54": ___syscall54, "___syscall6": ___syscall6, "___syscall91": ___syscall91, "___unlock": ___unlock, "__addDays": __addDays, "__arraySum": __arraySum, "__emscripten_do_request_fullscreen": __emscripten_do_request_fullscreen, "__get_canvas_element_size": __get_canvas_element_size, "__isLeapYear": __isLeapYear, "__setLetterbox": __setLetterbox, "__set_canvas_element_size": __set_canvas_element_size, "_abort": _abort, "_add_id_class": _add_id_class, "_create_cell": _create_cell, "_emscripten_asm_const_di": _emscripten_asm_const_di, "_emscripten_asm_const_i": _emscripten_asm_const_i, "_emscripten_asm_const_id": _emscripten_asm_const_id, "_emscripten_asm_const_ii": _emscripten_asm_const_ii, "_emscripten_asm_const_iii": _emscripten_asm_const_iii, "_emscripten_exit_fullscreen": _emscripten_exit_fullscreen, "_emscripten_get_canvas_element_size": _emscripten_get_canvas_element_size, "_emscripten_memcpy_big": _emscripten_memcpy_big, "_emscripten_request_fullscreen": _emscripten_request_fullscreen, "_emscripten_set_canvas_element_size": _emscripten_set_canvas_element_size, "_emscripten_set_click_callback_on_thread": _emscripten_set_click_callback_on_thread, "_emscripten_set_mousedown_callback_on_thread": _emscripten_set_mousedown_callback_on_thread, "_emscripten_set_mouseup_callback_on_thread": _emscripten_set_mouseup_callback_on_thread, "_emscripten_vibrate": _emscripten_vibrate, "_getenv": _getenv, "_llvm_stackrestore": _llvm_stackrestore, "_llvm_stacksave": _llvm_stacksave, "_pthread_cond_wait": _pthread_cond_wait, "_remove_id_class": _remove_id_class, "_remove_polygons": _remove_polygons, "_strftime": _strftime, "_strftime_l": _strftime_l, "_toggle_cell_class": _toggle_cell_class, "_toggle_id_class": _toggle_id_class, "DYNAMICTOP_PTR": DYNAMICTOP_PTR, "tempDoublePtr": tempDoublePtr, "STACKTOP": STACKTOP, "STACK_MAX": STACK_MAX };
...
var real___GLOBAL__sub_I_html_cpp = asm["__GLOBAL__sub_I_html_cpp"]; asm["__GLOBAL__sub_I_html_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real___GLOBAL__sub_I_html_cpp.apply(null, arguments);
};
...
var real____em_js__add_id_class = asm["___em_js__add_id_class"]; asm["___em_js__add_id_class"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real____em_js__add_id_class.apply(null, arguments);
};

var real____em_js__create_cell = asm["___em_js__create_cell"]; asm["___em_js__create_cell"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real____em_js__create_cell.apply(null, arguments);
};

var real____em_js__remove_id_class = asm["___em_js__remove_id_class"]; asm["___em_js__remove_id_class"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real____em_js__remove_id_class.apply(null, arguments);
};

var real____em_js__remove_polygons = asm["___em_js__remove_polygons"]; asm["___em_js__remove_polygons"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real____em_js__remove_polygons.apply(null, arguments);
};

var real____em_js__toggle_cell_class = asm["___em_js__toggle_cell_class"]; asm["___em_js__toggle_cell_class"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real____em_js__toggle_cell_class.apply(null, arguments);
};

var real____em_js__toggle_id_class = asm["___em_js__toggle_id_class"]; asm["___em_js__toggle_id_class"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real____em_js__toggle_id_class.apply(null, arguments);
};
...
var real__update_radius = asm["_update_radius"]; asm["_update_radius"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__update_radius.apply(null, arguments);
};
...
var __GLOBAL__sub_I_html_cpp = Module["__GLOBAL__sub_I_html_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_html_cpp"].apply(null, arguments) };
...
var ___em_js__add_id_class = Module["___em_js__add_id_class"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["___em_js__add_id_class"].apply(null, arguments) };
var ___em_js__create_cell = Module["___em_js__create_cell"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["___em_js__create_cell"].apply(null, arguments) };
var ___em_js__remove_id_class = Module["___em_js__remove_id_class"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["___em_js__remove_id_class"].apply(null, arguments) };
var ___em_js__remove_polygons = Module["___em_js__remove_polygons"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["___em_js__remove_polygons"].apply(null, arguments) };
var ___em_js__toggle_cell_class = Module["___em_js__toggle_cell_class"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["___em_js__toggle_cell_class"].apply(null, arguments) };
var ___em_js__toggle_id_class = Module["___em_js__toggle_id_class"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["___em_js__toggle_id_class"].apply(null, arguments) };
...
var _update_radius = Module["_update_radius"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_update_radius"].apply(null, arguments) };
