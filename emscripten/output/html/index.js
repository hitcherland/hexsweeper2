...
function _create_cell(h,j,x,y,points){ var points = UTF8ToString( points ); var polygon = document.createElementNS( "http://www.w3.org/2000/svg", "polygon" ); $( polygon ) .appendTo( "#game" ) .attr({ "id": `cell_${h}_${j}`, "data-h": h, "data-j": j, "transform": `matrix(1,0,0,1,${x},${y})`, "points": points }); }
function _create_options_page(){ var full_page = $( '<div id="options"></div>' ).appendTo( document.body ); }



STATIC_BASE = GLOBAL_BASE;

STATICTOP = STATIC_BASE + 27456;
...
var real____em_js__create_options_page = asm["___em_js__create_options_page"]; asm["___em_js__create_options_page"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real____em_js__create_options_page.apply(null, arguments);
};
...
var ___em_js__create_options_page = Module["___em_js__create_options_page"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["___em_js__create_options_page"].apply(null, arguments) };
